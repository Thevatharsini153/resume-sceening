...
GOOGLE_CLIENT_ID = "670155896547-jouh258qfpi8b802mj67ea122qoib8bi.apps.googleusercontent.com"
...
app.config['MONGO_URI']= 'mongodb+srv://admin:admin@cluster0.9wg2xji.mongodb.net/ResumeRanking'
